...
vegaEmbed("#industry1", vg_2, { theme: "urbaninstitute" }).then(function (result) { }).catch(console.error);
vegaEmbed("#industry2", vg_4, { theme: "urbaninstitute" }).then(function (result) { }).catch(console.error);

mapButtn.onclick = function () {
    vegaEmbed("#world", vg_1).then(function (result) { }).catch(console.error);
};
lineButtn.onclick = function () {
    vegaEmbed("#world", vg_3, { theme: "urbaninstitute" }).then(function (result) { }).catch(console.error);
};
